  ...
  return (
    <div className="grid gap-3">
      {rows.map((bucket, index) => (
        <div
          className="grid gap-3 rounded-2xl border border-[#edf1ee] bg-[#f8fbf7] p-3 md:grid-cols-[1fr_0.75fr_0.75fr_0.75fr_auto]"
        ...
        >
          ...
          <label className={labelClass}>
            ...
            <input
              ...
              step="0.01"
              value={bucket.fee}
              onChange={(event) => updateRow(index, 'fee', event.target.value)}
              required
            />
          </label>
          <button
